...
type ScreenProps = Omit<React.ComponentProps<typeof PlanEditor>, "onSubmit" | "submitLabel"> & {
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <Text style={styles.heroBody}>
          Set your usual order once. We’ll prepare each day automatically and keep the exceptions
          easy to edit.
        </Text>
